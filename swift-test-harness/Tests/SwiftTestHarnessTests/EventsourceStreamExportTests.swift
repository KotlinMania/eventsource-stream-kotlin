...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `EventsourceStream.swiftmodule/`
...
//      `import EventsourceStream` above would fail at compile time.
//
//   2. The static archive `libEventsourceStream.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "EventsourceStream" }` and
//      `flattenPackage = "io.github.kotlinmania.eventsourcestream"` configuration in
...
//      via the `EventsourceStreamLibrary` product.
//
