...
This file is the quick-reference operating contract for eventsource-stream-kotlin. The longer
...
eventsource-stream-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`eventsource-stream`](https://crates.io/crates/eventsource-stream). Upstream Rust is the behavioral oracle while the
