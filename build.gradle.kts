...
kotlin {
    ...
    val xcf = XCFramework("EventsourceStream")

    macosArm64 {
        binaries.framework { baseName = "EventsourceStream"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "EventsourceStream"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "EventsourceStream"
        flattenPackage = "io.github.kotlinmania.eventsourcestream"
    }

    android {
        namespace = "io.github.kotlinmania.eventsourcestream"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "eventsource-stream-kotlin", version.toString())

    pom {
        name.set("eventsource-stream-kotlin")
        description.set("Kotlin Multiplatform port of jpopesculian/eventsource-stream - A basic building block for building an Eventsource from a Stream of bytes")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/eventsource-stream-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/eventsource-stream-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/eventsource-stream-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/eventsource-stream-kotlin.git")
        }
    }
}
...
val fullTargetBuildTaskNames = setOf(
    ...
    "assembleEventsourceStreamXCFramework",
    "assembleEventsourceStreamDebugXCFramework",
    "assembleEventsourceStreamReleaseXCFramework",
    "assembleDebugIosFatFrameworkForEventsourceStreamXCFramework",
    "assembleReleaseIosFatFrameworkForEventsourceStreamXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForEventsourceStreamXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForEventsourceStreamXCFramework",
    "assembleDebugMacosFatFrameworkForEventsourceStreamXCFramework",
    "assembleReleaseMacosFatFrameworkForEventsourceStreamXCFramework",
    "assembleDebugTvosFatFrameworkForEventsourceStreamXCFramework",
    "assembleReleaseTvosFatFrameworkForEventsourceStreamXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForEventsourceStreamXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForEventsourceStreamXCFramework",
    "assembleDebugWatchosFatFrameworkForEventsourceStreamXCFramework",
    "assembleReleaseWatchosFatFrameworkForEventsourceStreamXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForEventsourceStreamXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForEventsourceStreamXCFramework",
...
// pipeline, which bypasses K2JVMCompiler.doExecute — the hook the CodeQL Java
// agent uses to extract Kotlin TRAP. A single-target kotlinc invocation
// (no -Xfragments) routes through doExecute, so the agent's class-load hook
// fires and per-source .kt.trap.gz files appear under CODEQL_EXTRACTOR_JAVA_TRAP_DIR.
...
dependencies {
    ...
    // sibling dependencies. The configuration is wired in so the AAR-extraction code path is
    // ready when Android AAR dependencies are added.
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/eventsourcestream/codeql/_CodeqlEmptySource.kt")
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.eventsourcestream.codeql
